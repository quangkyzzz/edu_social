...
import 'package:social_app/features/home/exam_feature/manage_feature/manage_review_answer.dart';

/// Widget that displays the summary of the quiz
class ManageScorePage extends StatefulWidget {
  ...
  @override
  State<ManageScorePage> createState() => _ScoreState();
}

class _ScoreState extends State<ManageScorePage> {
  @override
                        ...
                        ActionButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ManageReviewAnswer(quiz: widget.quiz),
                                ),
                              );
                            }),
                        ActionButton(
