...
class ManageReviewAnswer extends StatelessWidget {
  /// Quiz object containing all information of quiz
  final Quiz quiz;

  /// Constructor
  const ManageReviewAnswer({super.key, required this.quiz});
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final userAnswerColor =
                      userAnswerIndex == correctAnswerIndex ? Colors.greenAccent[700] : Colors.redAccent[700];
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              (userAnswerIndex != null && userAnswerIndex != -1)
                                  ? "Answer: ${question.options[userAnswerIndex]}"
                                  : "This question skipped",
